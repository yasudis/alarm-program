...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IIcmpPingProbe, SystemIcmpPingProbe>();
        services.AddSingleton<IHostWatchdog, SystemHostWatchdog>();
        services.AddSingleton<IHttpEndpointProbe, SystemHttpEndpointProbe>();
        services.AddSingleton<IHttpEndpointWatchdog, SystemHttpEndpointWatchdog>();
        services.AddSingleton<ISystemSnapshotProvider, WindowsSystemSnapshotProvider>();
