...
public class WindowsEventLogReaderTests
{
    ...
    public void AddInfrastructure_registers_event_collector_and_settings_store()
    {
        ...
        Assert.NotNull(provider.GetRequiredService<IUsbDeviceMonitor>());
        Assert.NotNull(provider.GetRequiredService<IServiceWatchdog>());
        Assert.NotNull(provider.GetRequiredService<IPendingRebootMonitor>());
        Assert.NotNull(provider.GetRequiredService<IHostWatchdog>());
        Assert.NotNull(provider.GetRequiredService<IHttpEndpointWatchdog>());
        Assert.NotNull(provider.GetRequiredService<ISystemSnapshotProvider>());
        Assert.NotNull(provider.GetRequiredService<IIcmpPingProbe>());
        Assert.NotNull(provider.GetRequiredService<IHttpEndpointProbe>());
        Assert.NotNull(provider.GetRequiredService<ISmtpMailSender>());
        Assert.NotNull(provider.GetRequiredService<IAlertSoundPlayer>());
        Assert.NotNull(provider.GetRequiredService<ITrayBalloonNotifier>());
